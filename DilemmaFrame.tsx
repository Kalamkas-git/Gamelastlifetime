...
export const DilemmaFrame: React.FC<DilemmaFrameProps> = ({ 
  ...
  return (
    <div className={`relative w-full max-w-2xl mx-auto transition-all duration-700 transform ${isFadingOut ? 'opacity-0 translate-y-8' : 'opacity-100 translate-y-0'}`}>
      ...
      <div className="relative bg-[#0a0a0a] shadow-[0_10px_60px_rgba(0,0,0,1)] rounded-sm overflow-hidden group">
        ...
        <div className="relative p-6 md:p-10 z-0 bg-[#121212]">
          ...
          <div className="relative z-10 text-center">
             ...
             <div className="mb-10 font-serif text-lg md:text-xl text-[#dcdcdc] leading-relaxed px-2">
             ...
             <div className="grid gap-3">
               {scene.choices.map((choice, idx) => (
                 ...
                 >
                   <div className="absolute inset-0 bg-[#1e1e24] border border-[#3a3a40] group-hover:border-[#d4af37]/60 transition-colors"></div>
                   ...
                   <div className="relative z-10 flex flex-col gap-1 pl-2 border-l-2 border-transparent group-hover:border-[#d4af37] transition-all">
                      <div className="flex justify-between items-baseline">
                        <span className="text-gray-300 group-hover:text-[#ffe4b5] font-serif text-base md:text-lg transition-colors">
                          {choice.text}
                        </span>
                      ...
                      {choice.flavor && (
                        <span className="text-[11px] text-gray-500 group-hover:text-[#8B4513] italic font-serif transition-colors mt-0.5">
                          {choice.flavor}
                        </span>
                      )}
                   </div>
